        ...
        {detail ? (
          <>
            <ScrollReveal distance={40} threshold={0.06}>
              <p className="project-lead mt-10 max-w-3xl md:mt-14">{detail.lead}</p>
            </ScrollReveal>
                ...
                <section className="section-rule py-14 md:py-20">
                  ...
                  <div className="mt-8 max-w-2xl space-y-6 md:mt-10">
                    {section.body.length > 0 && (
                      <p className="body-text">{section.body[0]}</p>
                    )}
                    {section.diagram && (
            ...
            <ScrollReveal distance={40} threshold={0.1}>
              <section className="section-rule py-14 md:py-20">
                ...
                <p className="closing-quote mt-8 md:mt-10">{detail.reflection}</p>
              </section>
            </ScrollReveal>
          </>
        ) : (
